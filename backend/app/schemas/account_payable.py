...
class AccountPayableBase(BaseModel):
    ...
    due_date: date
    status: PayableStatus = PayableStatus.UNPAID
...
class AccountPayableUpdate(BaseModel):
    reference_no: str | None = Field(default=None, min_length=1, max_length=64)
...
class AccountPayableRead(AccountPayableBase):
